...
func TestCheckConnectBlockTemplate(t *testing.T) {
	...
	err = chain.CheckConnectBlockTemplate(convert.NewBlockFromShellMsgBlock(convert.MsgBlockToShell(&invalidPowBlock)))
	if err != nil {
		t.Fatalf("CheckConnectBlockTemplate: Received unexpected error on "+
	...
	err = chain.CheckConnectBlockTemplate(convert.NewBlockFromShellMsgBlock(convert.MsgBlockToShell(&invalidBlock)))
	if err == nil {
		t.Fatal("CheckConnectBlockTemplate: Did not received expected error " +
...
func TestCheckBlockSanity(t *testing.T) {
	...
	block := convert.NewBlockFromShellMsgBlock(&Block100000)
...
func TestCheckSerializedHeight(t *testing.T) {
	...
	for i, test := range tests {
		...
		tx := btcutil.NewTx(convert.MsgTxToBtc(msgTx))
